...
//         private string __databaseFile = "BoatClub.json";
//         XDocument xmlDoc;
...
//         public dynamic searchUniqueMember(int memberID)
//         {
//             // Member member = new Member (){
//             //                     ID = (string)databaseDocument.Descendants("Member")
//             //                         .Where(id => (int)id
//             //                         .Attribute("memberId") == memberID).Single().Attribute("memberId")
//             //                         };
//             // var newMember =  new Member () {
//             //     ID = (string)member.Element("memberId"),
//             //     name = (string)member.Attribute("name"),
//             //     socialSecurityNumber = (string)member.Attribute("SSN"),
//             // };
//             // System.Console.WriteLine("member " + member.Attribute("memberId").Value);
//             // System.Console.WriteLine("Apa" + newMember.ID);
//             // return member;
